...
enum SearchMode {
  unitTab, dataTab, teamTab, rumbleTab, regularUnitSearch
}
...
class _CustomSearchBarState extends State<CustomSearchBar> {
  ...
  Widget build(BuildContext context) {
    bool showFilter = (widget.controller?.text.length ?? 0) >= 3 &&
        (widget.mode == SearchMode.dataTab || widget.mode == SearchMode.regularUnitSearch);
    return AnimatedContainer(
      duration: Duration(milliseconds: 300),
      height: showFilter ? CustomSearchBar.filterHeight : CustomSearchBar.normalHeight,
          ...
          child: Visibility(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  typeFilter(Data.allType, Colors.grey, gradient: LinearGradient(
                      colors: [UI.strT, UI.qckT, UI.dexT, UI.psyT, UI.intT],
      ...
      child: FittedBox(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: _type == type ? Border.all(
                  color: StorageUtils.readData(StorageUtils.darkMode, false)
                      ? Colors.white : Colors.black, width: 2) : null
          ),
