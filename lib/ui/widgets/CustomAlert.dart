...
class UIAlert extends StatefulWidget {
  ...
  final bool cancel;
  UIAlert({required this.title, this.textSize = 18, this.content,
    required this.acceptButton, required this.dialogContext,
    required this.onAccepted, this.cancel = true});
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        actions: <Widget> [
          ...
          TextButton(
            child: Text(widget.acceptButton, style: TextStyle(color: Colors.red)),
            onPressed: () {
              widget.onAccepted();
            },
          )
