  ...
  _disclaimerInformationDialog(InformationLabel mode) {
    switch (mode) {
      case InformationLabel.copyright:
        ChoiceBottomSheet.callModalSheet(context, mode.label, CopyrightTile(), height: 3);
        break;
      case InformationLabel.developers:
        ChoiceBottomSheet.callModalSheet(context, mode.label, DeveloperTile(), height: 3);
        break;
      case InformationLabel.contributors:
        ChoiceBottomSheet.callModalSheet(context, mode.label, ContributorsTile(), height: 3);
        break;
                ...
                Navigator.of(context).push(
                  CupertinoPageRoute(builder: (context) {
                    return LicensePage(
                      ...
                      applicationIcon: Container(width: 150, height: 150, child: Image.asset("res/icons/license_icon.png")),
                    );
                  }),
                );
              }
