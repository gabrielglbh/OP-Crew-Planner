...
import 'package:optcteams/ui/pages/buildPages/buildMaxedUnit/widgets/AttributeUnit.dart';
import 'package:optcteams/ui/pages/buildPages/buildMaxedUnit/widgets/InfoButton.dart';
import 'package:optcteams/ui/pages/buildPages/buildMaxedUnit/widgets/ReadyButton.dart';
...
class BuildMaxedUnitPage extends StatefulWidget {
  ...
  final bool update;
  BuildMaxedUnitPage({required this.toBeUpdatedUnit, required this.update});
  ...
  _validateAndInsertOnDB() {
    ...
    UnitQueries.instance.updateUnit(_updateUnit).then((isSuccessful) async {
      if (isSuccessful) {
        ...
        else await UpdateQueries.instance.registerAnalyticsEvent(AnalyticsEvents.createdUnitToBeMaxed);
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("subtitleUnitPage".tr(), textAlign: TextAlign.center, style: TextStyle(fontSize: 18)),
            ),
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          return AttributeUnit(
            ...
            onTap: () {
              if (_updateUnit.id != "noimage") setState(() => _checks[index] = !_checks[index]);
              else UI.showSnackBar(context, "errOnChangeAttr".tr());
            },
            color: _checks[index]
              ? Colors.orange[400]
              : (StorageUtils.readData(StorageUtils.darkMode, false) ? Colors.grey[800] : Colors.white),
