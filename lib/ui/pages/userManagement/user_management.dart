...
import 'package:optcteams/ui/pages/userManagement/widgets/LoginButton.dart';
...
class UserManagementPage extends StatefulWidget {
  ...
  UserManagementPage({required this.mode, this.deleteAccount = false});
  ...
  String? _validateCredentials(String hint, String term) {
    ...
    if (hint == "hintPassword".tr() || hint == "hintActualPassword".tr()
      ...
      if (term.length < 8 || term.isEmpty) {
        if (hint == "hintPassword".tr()) return "errPasswordNotValid".tr();
        else if (hint == "hintActualPassword".tr()) return "errActualPasswordNotValid".tr();
        else if (hint == "hintNewPassword".tr()) return "errNewPasswordNotValid".tr();
      }
    }
    return null;
  }
