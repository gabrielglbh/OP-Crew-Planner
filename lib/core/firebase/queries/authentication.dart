...
class AuthQueries {
      ...
      try {
        if (mode == UserMode.logIn) {
          ...
          UpdateQueries.instance
              .registerAnalyticsEvent(AnalyticsEvents.signInPwd);
          ...
          UserCredential? credential = await _auth?.signInWithEmailAndPassword(
              email: email, password: password);
          UpdateQueries.instance
              .registerAnalyticsEvent(AnalyticsEvents.logInPwd);
          user = credential?.user;
        }
      } catch (err) {
  ...
  Future<User?> handleGoogleSignIn(BuildContext context) async {
    ...
    try {
      ...
      if (googleUser != null) {
        ...
        UpdateQueries.instance
            .registerAnalyticsEvent(AnalyticsEvents.logInGoogle);
  ...
  Future<void> closeSession() async {
    ...
    await UpdateQueries.instance
        .registerAnalyticsEvent(AnalyticsEvents.closeSessionPwd);
  }
  ...
  Future<bool> changePassword(
      BuildContext context, String previousPassword, String newPassword) async {
    try {
      User? user = _auth?.currentUser;
